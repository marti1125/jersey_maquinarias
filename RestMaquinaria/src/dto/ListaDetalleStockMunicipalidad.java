...
public class ListaDetalleStockMunicipalidad {
	...
	public ListaDetalleStockMunicipalidad(String codigoStockMunicipalidad, String nombreTipoMaquinaria,
			long idDetalleStockMunicipalidad, String fechaInicio, String fechaFin,
			double costoTotal) {
		super();
